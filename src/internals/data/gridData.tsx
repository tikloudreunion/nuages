...
export function renderAvatar(
  ...
  return (
    <Avatar
      sx={{
        backgroundColor: params.value && typeof params.value === 'object' && 'color' in params.value
          ? (params.value as { color?: string }).color || 'grey'
          : 'grey',
        width: '24px',
        height: '24px',
        fontSize: '0.85rem',
    ...
    >
      {(params.value && typeof (params.value as { name?: string }).name === 'string'
...
export const columns: GridColDef[] = [
  { field: 'pageTitle', headerName: 'Page Title', flex: 1.5, minWidth: 200 },
  {
    ...
    renderCell: (params) => {
      ...
      return <Chip label={params.value as 'Online' | 'Offline'} color={colors[params.value as string]} size="small" />;
    },
  },
  {
    field: 'users',
